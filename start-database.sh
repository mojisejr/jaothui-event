...
DB_CONTAINER_NAME="jaothui-event-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=jaothui-event -d -p 5432:5432 docker.io/postgres
